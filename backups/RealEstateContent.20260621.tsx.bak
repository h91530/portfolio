  ...
  return (
    <div className="about-page">
      ...
      <section className="about-section" id="overview">
        <h2>프로젝트 개요</h2>
        <p>
          <strong>핵심 문제:</strong> 월세 거주자들이 &ldquo;지금 월세가 정상인가? 구입하는 게 이득인가?&rdquo;를 판단할 객관적 근거가 없습니다.
        ...
        <div className="about-projects">
          <article className="project-card">
            <div className="project-content">
              ...
              <p>
                사용자는 &ldquo;시도 → 시군구 → 동&rdquo; 3단계를 차례로 선택합니다.
          ...
          <article className="project-card">
            <div className="project-content">
              ...
              <p>
                <strong>핵심 로직:</strong> 사용자가 입력한 &ldquo;보증금&rdquo;과 &ldquo;월세&rdquo;에서 월 지출액을 계산합니다.
                (예: 보증금 5천만원 + 월세 100만원 = 보증금 기회비용 포함 월 지출액 약 155만원)
                <br />
                그 다음 API로 조회한 최근 24개월 거래 데이터에서 해당 건물의 평균 거래가를 산출합니다.
                평균 거래가 대비 &ldquo;월세가 손해인가?&rdquo;를 객관적으로 판단할 수 있습니다.
                <br />
                <strong>중요한 점:</strong> 단순 평균이 아니라, 최근 거래 추세도 함께 표시하므로
                &ldquo;가격이 오르는 시장인가? 내리는 시장인가?&rdquo;도 파악할 수 있습니다.
              </p>
              <div className="project-tags">
          ...
          <article className="project-card">
            <div className="project-content">
              ...
              <p>
                데이터 비교만으로는 부족합니다. 사용자가 &ldquo;실제로 전월세 전환을 고려한다&rdquo;면,
          ...
          <article className="project-card">
            <div className="project-content">
              ...
              <p>
                ...
                &ldquo;상담 전환된 사용자&rdquo;와 &ldquo;미전환 사용자&rdquo;를 구분하여 관리하고,
          ...
          <article className="project-card">
            <div className="project-content">
              ...
              <p>
                ...
                &ldquo;접수 → 검토 중 → 상담 완료 → 계약 진행&rdquo; 같은 상태 변화를 기록하고,
